...
$(COMPILED_RUN_FILE): $(RUN_FILE) $(OBJECT_FILES)
	$(CC) $(RUN_FILE) $(OBJECT_FILES) -o $(COMPILED_RUN_FILE)

run: $(TARGET)
	rm -f $(RUN_FILE) $(COMPILED_RUN_FILE)
	$(OUTPUT_FILE) $(FILE)
	$(MAKE) $(COMPILED_RUN_FILE)
	$(COMPILED_RUN_FILE)

compile:
	rm -f $(COMPILED_RUN_FILE)
	$(MAKE) $(COMPILED_RUN_FILE)
	$(COMPILED_RUN_FILE)

clean:
	rm -rf $(COMPILATION_FOLDER) $(RUN_FILE) $(COMPILED_RUN_FILE)